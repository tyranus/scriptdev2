...
bool GossipHello_TeleNPC(Player* pPlayer, Creature* pCreature)
{
	...
	if(SD2Config.GetBoolDefault("TeleNPC.OnlyGMs", false)) // If TeleNPC.OnlyGMs is enabled in scriptdev2.conf
		...
		{
			pCreature->MonsterWhisper("Ola, sou exclusivo para VIP. Acesse www.bloodarena.com.br um para sua conta!", pPlayer->GetGUID());
			return true;
		}
	...
	if(EnableAlliancevsHordePvP)
		pPlayer->ADD_GOSSIP_ITEM( 9, "Ir para Vip Place"        , GOSSIP_SENDER_MAIN, 3500);
...
case 5010: //Kalimdor
	...
	pPlayer->ADD_GOSSIP_ITEM( 7, "<- Voltar"                          , GOSSIP_SENDER_MAIN, 5000);
...
case 5015: //Eastern Kingdoms 1
	...
	pPlayer->ADD_GOSSIP_ITEM( 7, "Mais ->"                          , GOSSIP_SENDER_MAIN, 5020);
	pPlayer->ADD_GOSSIP_ITEM( 7, "<- Voltar"                          , GOSSIP_SENDER_MAIN, 5000);
...
case 5020: //Eastern Kingdoms 2
	...
	pPlayer->ADD_GOSSIP_ITEM( 7, "<- Voltar"                          , GOSSIP_SENDER_MAIN, 5015);
	pPlayer->ADD_GOSSIP_ITEM( 7, "<- Menu Principal"                     , GOSSIP_SENDER_MAIN, 5005);
...
case 4000: // Player Tools
	...
	if(EnableInnkeeper)
		pPlayer->ADD_GOSSIP_ITEM( 5, "Grave este lugar em minha pedra."  , GOSSIP_SENDER_MAIN, 4005);
	pPlayer->ADD_GOSSIP_ITEM( 5, "Resetar Talentos"              , GOSSIP_SENDER_MAIN, 4010);
      // Check if player is Hunter for "Reset Pet Talent Points"
	if(pPlayer->getClass()==3)
		pPlayer->ADD_GOSSIP_ITEM( 5, "Resetar Pet Talents"    , GOSSIP_SENDER_MAIN, 4015);
